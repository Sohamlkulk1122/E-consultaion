...
import { X, Download, TrendingUp, MessageCircle, BarChart3, Sparkles, Brain, Target } from 'lucide-react';
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/50">
                    <div className="bg-gradient-to-r from-slate-100 to-zinc-100 p-6 rounded-xl border-l-4 border-slate-500">
                      <p className="text-slate-800 leading-relaxed text-lg font-medium">{summary}</p>
                    </div>
                  </div>
                </div>
              </div>
